...
export default function LandingPage() {
  return (
    <div className="relative min-h-screen bg-[#09090b] text-zinc-100 flex flex-col justify-between overflow-hidden">
      ...
      <header className="w-full max-w-7xl mx-auto px-6 py-6 flex justify-between items-center z-10">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link
            href="/signup"
            className="text-sm font-medium bg-zinc-800 text-zinc-100 hover:bg-zinc-700 border border-zinc-700/50 px-4 py-2 rounded-lg transition-all"
          >
            Create Account
          </Link>
        </div>
      ...
      <main className="flex-1 flex flex-col items-center justify-center text-center px-6 max-w-5xl mx-auto z-10 py-12">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-indigo-500/10 border border-indigo-500/20 text-xs font-semibold text-indigo-300 mb-6 animate-pulse">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-20">
          ...
          <Link
            href="/login"
            className="flex items-center justify-center bg-zinc-900 border border-zinc-800 text-zinc-300 hover:text-zinc-100 hover:bg-zinc-800 font-semibold px-8 py-4 rounded-xl transition-all"
          >
            Access Dashboard
          </Link>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full text-left">
          ...
          <div className="glass-panel rounded-2xl p-6 relative group overflow-hidden transition-all duration-300 hover:border-indigo-500/30">
            ...
            <div className="h-12 w-12 rounded-xl bg-zinc-800/80 border border-zinc-700/50 flex items-center justify-center text-indigo-400 mb-5">
              <BookOpen className="h-6 w-6" />
            </div>
            <h3 className="text-lg font-bold mb-2 group-hover:text-indigo-300 transition-colors">Notes Vault</h3>
          ...
          <div className="glass-panel rounded-2xl p-6 relative group overflow-hidden transition-all duration-300 hover:border-purple-500/30">
            ...
            <div className="h-12 w-12 rounded-xl bg-zinc-800/80 border border-zinc-700/50 flex items-center justify-center text-purple-400 mb-5">
              <Layers className="h-6 w-6" />
            </div>
            <h3 className="text-lg font-bold mb-2 group-hover:text-purple-300 transition-colors">Active Recall Decks</h3>
            <p className="text-sm text-zinc-400 leading-relaxed">
          ...
          <div className="glass-panel rounded-2xl p-6 relative group overflow-hidden transition-all duration-300 hover:border-emerald-500/30">
            ...
            <div className="h-12 w-12 rounded-xl bg-zinc-800/80 border border-zinc-700/50 flex items-center justify-center text-emerald-400 mb-5">
              <CheckSquare className="h-6 w-6" />
            </div>
            <h3 className="text-lg font-bold mb-2 group-hover:text-emerald-300 transition-colors">Prioritized Tasks</h3>
            <p className="text-sm text-zinc-400 leading-relaxed">
      ...
      {/* Footer */}
      <footer className="w-full max-w-7xl mx-auto px-6 py-8 border-t border-zinc-800/50 text-center text-xs text-zinc-500 z-10">
